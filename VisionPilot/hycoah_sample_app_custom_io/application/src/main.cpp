...
#define exfwk_config_file_path "./exfwk_config_v4h.json"
#define buffer_manager_config_file_path "./hwa_mmngr_partion_example_v4h.json"
#elif defined(RCAR_V4M)
#define exfwk_config_file_path "./exfwk_config_v4m.json"
#define buffer_manager_config_file_path "./hwa_mmngr_partion_example_v4m.json"
#endif
